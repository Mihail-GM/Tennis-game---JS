...
canvasBackgroundImageSetting.src = "img/background3.jpg";
...
var winAudio = new Audio("cheer1.mp3"); // buffers automatically when created
var isPlaing = true;
...
function initGlobals(){
 ...
 //paddle1 = new Paddle(140, 30, 445, 15, "img/paddle2.png");
    // Creating paddles
	if(paddle1 == null) {
...
function handleMouseClick(evt) {
    ...
    if(showingMenuScreen && collision(buttonSinglePlayer, mousePos)){ 
	 ...
	 if(playerChooser && collision(buttonPlayer2Skin, mousePos)){
	  ...
	  paddle1 = new Paddle(140, 30, 445, 15, "img/paddle3.png");
	  initGlobals();
	 }
